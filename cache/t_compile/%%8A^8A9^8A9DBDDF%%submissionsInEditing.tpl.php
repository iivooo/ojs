<?php /* Smarty version 2.6.26, created on 2017-03-09 15:31:37
         compiled from editor/submissionsInEditing.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sort_search', 'editor/submissionsInEditing.tpl', 17, false),array('function', 'translate', 'editor/submissionsInEditing.tpl', 18, false),array('function', 'sort_heading', 'editor/submissionsInEditing.tpl', 18, false),array('function', 'url', 'editor/submissionsInEditing.tpl', 43, false),array('function', 'page_info', 'editor/submissionsInEditing.tpl', 67, false),array('function', 'page_links', 'editor/submissionsInEditing.tpl', 68, false),array('block', 'iterate', 'editor/submissionsInEditing.tpl', 32, false),array('modifier', 'escape', 'editor/submissionsInEditing.tpl', 38, false),array('modifier', 'date_format', 'editor/submissionsInEditing.tpl', 40, false),array('modifier', 'truncate', 'editor/submissionsInEditing.tpl', 42, false),array('modifier', 'strip_tags', 'editor/submissionsInEditing.tpl', 43, false),)), $this); ?>
<div id="submissions">
<table width="100%" class="listing">
	...
	<tr class="heading" valign="bottom">
		...
		<td width="10%"><?php echo $this->_plugins['function']['sort_search'][0][0]->smartySortSearch(array('key' => "article.authors",'sort' => 'authors'), $this);?>
</td>
		<td width="20%"><?php echo $this->_plugins['function']['sort_search'][0][0]->smartySortSearch(array('key' => "article.title",'sort' => 'title'), $this);?>
</td>
...
?><?php echo ((is_array($_tmp=$this->_tpl_vars['editAssignment']->getEditorInitials())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
 <?php endforeach; endif; unset($_from); ?>
	...
	<tr>
		<td colspan="10" class="<?php if ($this->_tpl_vars['submissions']->eof()): ?>end<?php endif; ?>separator">&nbsp;</td>
	</tr>
<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo $this->_plugins['block']['iterate'][0][0]->smartyIterate($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
<?php if ($this->_tpl_vars['submissions']->wasEmpty()): ?>
	<tr>
		<td colspan="10" class="nodata"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "submissions.noSubmissions"), $this);?>
</td>
	</tr>
	<tr>
