...
<tr valign="top">
	...
	<td width="80%" class="value"><input type="file" name="uploadSuppFile" id="uploadSuppFile" class="uploadField" onchange="handleFileSelect(this.id)" />&nbsp;&nbsp;<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "form.saveToUpload"), $this);?>
</td>
</tr>
<?php if (! ( $this->_tpl_vars['suppFile'] && $this->_tpl_vars['suppFile']->getFileId() )): ?>
<tr valign="top">
