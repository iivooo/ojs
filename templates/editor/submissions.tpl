...
<div class="descriptions">
	...
	<ul>
		<li>.. see the uploaded submissions with the corresponding <a href="https://app.originstamp.org/">originstamp.org</a> functionality on the right. </li>
		<li>.. click on a submission to assign it to section editors or yourself. After this the assigned editors can assign reviewers.</li>
		<li>.. click on a submission to have correspondence (comments) with authors/ reviewers/ others. These are timestamped too.</li>
	</ul>
</div>
